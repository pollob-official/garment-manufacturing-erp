        ...
        <div class="col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
            <div class="card flex-fill">
                <div class="card-header bg-primary">
                    <h5 class="card-title">Update Production Work Status</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('production-work-status.update', $productionWorkStatus->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-10">
                                <input type="text" name="status_name"
                                    value="{{ old('status_name', $productionWorkStatus->name) }}" class="form-control"
