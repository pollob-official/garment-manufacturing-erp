...
<x-success/>
    <div class="col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="card flex-fill">
            ...
            <div class="card-body">
                <form action="{{url("/hrm_employee_positions/{$positions['id']}")}}" method="POST">
                @csrf
                <input type="hidden" name="_method" value="put">
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label">Position Name :</label>
                        <div class="col-lg-10">
                            <input type="text" name="name" value="{{$positions['name']}}" class="form-control" placeholder="Enter Status Name..."  autocomplete="name">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            ...
                            <select name="department_id" id="departments_id"  class="form-select">
                                ...
                                <option {{ $positions->department_id ===  $department->id ? 'selected' : '' }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            ...
                            <select name="statuses_id" id="statuses_id"  class="form-select">
                                ...
                                <option {{ $positions->statuses_id ===  $data->id ? 'selected' : '' }}
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="salary" value="{{$positions['salary']}}" class="form-control" placeholder="Enter Role Name..."  autocomplete="name">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-lg-10">
                            <input type="text" name="description" value="{{$positions['description']}}" class="form-control" placeholder="Enter Role Name..."  autocomplete="name">
