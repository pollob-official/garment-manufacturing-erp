...
<x-success/>
    <div class="col-md-12 col-lg-12 col-xl-12 d-flex justify-content-center align-items-center" style="min-height: 80vh;">
        <div class="card flex-fill">
            <div class="text-end">
                <a href="{{url('/hrm_designations')}}" type="submit" class="btn btn-primary">Back</a>
            </div>
            <div class="card-header">
                <h5 class="card-title">Create Department</h5>
            </div>
            <div class="card-body">
                <form action="{{url('/hrm_designations')}}" method="POST">
                    @csrf
                    <div class="row mb-3">
                        <label class="col-lg-2 col-form-label">Designation Name :</label>
                        <div class="col-lg-10">
                    ...
                    <div class="text-end">
                        <button type="submit" class="btn btn-primary">Create New Sub_department</button>
                    </div>
                </form>
            </div>
        </div>
