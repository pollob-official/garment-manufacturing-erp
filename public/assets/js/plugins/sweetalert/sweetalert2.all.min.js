...
!(function (t, e) {
	...
	function Et(t, e) {
		...
		i &&
			...
			(n = e.position) in $
				? vt(o, $[n])
				: (W('The "position" parameter is not valid, defaulting to "center"'), vt(o, $.center)),
			(n = i),
			!(o = e.grow) || "string" != typeof o || ((o = "grow-".concat(o)) in $ && vt(n, $[o])),
			z(i, e, "container"),
			(e = document.body.getAttribute("data-swal2-queue-step")) &&
				(i.setAttribute("data-queue-step", e), document.body.removeAttribute("data-swal2-queue-step")));
	}
	function St(t, e) {
	...
	function ce(t) {
		for (var e in t)
			re((o = e)) || W('Unknown parameter "'.concat(o, '"')),
				t.toast && ((n = e), -1 !== de.indexOf(n) && W('The parameter "'.concat(n, '" is incompatible with toasts'))),
				ae((n = e)) && v(n, ae(n));
		var n, o;
	}
	var se = {
					...
					"object" !== r(n[0]) || C(n[0])
						? ["title", "html", "icon"].forEach(function (t, e) {
								...
								"string" == typeof e || C(e)
									? (o[t] = e)
									: void 0 !== e &&
									  K("Unexpected type of ".concat(t, '! Expected "string" or "Element", got ').concat(r(e)));
						  })
						: s(o, n[0]),
					o
				);
					...
					var n,
						...
						e =
							...
							function () {
								...
								return p(
									this,
									o ? ((t = u(this).constructor), Reflect.construct(e, arguments, t)) : e.apply(this, arguments)
								);
							});
					function i() {
	...
	var ve = function () {
			navigator.userAgent.match(/(CriOS|FxiOS|EdgiOS|YaBrowser|UCBrowser)/i) ||
				(x().scrollHeight > window.innerHeight - 44 && (k().style.paddingBottom = "".concat(44, "px")));
		},
		be = function () {
			var e,
				t = k();
	...
	function Ae(t, e, n, o) {
		n
			...
			bt(
				...
				[$.shown, $["height-auto"], $["no-backdrop"], $["toast-shown"], $["toast-column"]]
			);
	}
	function xe(t) {
		var e,
	...
	function je(t) {
		...
		(e = t).inputValidator ||
			...
			((n = t).target &&
				...
				(W('Target parameter is not valid, defaulting to "body"'), (n.target = "body")),
	...
	var Re = ["swal-title", "swal-html", "swal-footer"],
		...
		Ye = function (e, n) {
			g(e.attributes).forEach(function (t) {
				-1 === n.indexOf(t.name) &&
					W([
						'Unrecognized attribute "'.concat(t.name, '" on <').concat(e.tagName.toLowerCase(), ">."),
						"".concat(
							n.length
		...
		vn = function (t) {
			-1 !== [L(), q(), j()].indexOf(document.activeElement) &&
				((t = -1 !== dn.indexOf(t) ? "nextElementSibling" : "previousElementSibling"),
	...
	function xn(t, e) {
		...
		return (
			...
			(n.hideClass = i),
			!1 === t.animation &&
				((n.showClass = { popup: "swal2-noanimation", backdrop: "swal2-noanimation" }), (n.hideClass = {})),
			n
		);
	}
	function Bn(a, c, s) {
		...
		J = Object.freeze({
			...
			resetValidationMessage: function () {
				...
				t.validationMessage && at(t.validationMessage),
					(t = this.getInput()) &&
						(t.removeAttribute("aria-invalid"), t.removeAttribute("aria-describedBy"), bt(t, $.inputerror));
			},
